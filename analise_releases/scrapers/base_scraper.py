"""
Classe base para todos os scrapers do projeto analise_releases.
Concentra a logica compartilhada: configuracao do Selenium, logging,
download de arquivos e verificacao de duplicatas.

==================================================================
AVISO: Este arquivo e uma COPIA INDEPENDENTE de coleta/scrapers/base_scraper.py.
Os dois projetos compartilham a mesma classe base historicamente, mas vivem
em pacotes Python separados. Quando alterar algo aqui que tambem deva valer no
projeto de coleta de empreendimentos (ou vice-versa), atualize manualmente
o outro arquivo.
==================================================================
"""
